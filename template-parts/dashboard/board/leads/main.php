...
<section class="dashboard-content-wrap">
    <div class="dashboard-content-inner-wrap">
        <div class="dashboard-content-block-wrap">
            ...
            if (isset($_GET['id_prospectos_redet_as']))
            {
                $id_prospectos_redet_as = unserialize($_GET['id_prospectos_redet_as']);
                $public_redet_as = new Redet_As_0001_Public('redet-as-0001', '1.0.0');
                $leads = $public_redet_as->get_leads_redet_as($id_prospectos_redet_as);
            }
            else
            {
                                ...
                                <td>
                                    <div class="dropdown property-action-menu">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="edit-lead-redet-as dropdown-item open-close-slide-panel" data-id="<?php echo intval($result->lead_id)?>" href="#"><?php esc_html_e('Edit', 'houzez'); ?></a>

                                            <a href="" class="delete-lead-redet-as dropdown-item" data-id="<?php echo intval($result->lead_id); ?>" data-nonce="<?php echo wp_create_nonce('delete_lead_nonce') ?>"><?php esc_html_e('Delete', 'houzez'); ?></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
