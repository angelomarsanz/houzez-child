<div class="dashboard-slide-panel-wrap">
	...
	<form id="lead-form">
		<input type="hidden" name="action" value="houzez_crm_add_lead_redet_as">
		<div class="lined-block">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12">
					<div class="form-group">
						<label><?php esc_html_e('Document type', 'houzez'); ?></label>
						<select id="tipo_documento_redet_as" name="tipo_documento_redet_as" class="selectpicker form-control bs-select-hidden" title="<?php esc_html_e('Select', 'houzez'); ?>">
							<option value=""><?php esc_html_e('Select', 'houzez'); ?></option>
							<?php
							$tipo_documento_redet_as = hcrm_get_option('tipo_documento_redet_as', 'hcrm_lead_settings', esc_html__('E, G, J, P, V', 'houzez'));
							if(!empty($tipo_documento_redet_as)) {

								$tipos_documentos = explode(',', $tipo_documento_redet_as);
								foreach( $tipos_documentos as $tipo ) {
									echo '<option value="'.trim($tipo).'">'.esc_attr($tipo).'</value>';
								}
							}
							?>
						</select>
				...
				<div class="col-md-12 col-sm-12">
					<div class="form-group">
						<label><?php esc_html_e('number of card or RIF', 'houzez'); ?></label>
						<input class="form-control" id="cedula_rif_redet_as" name="cedula_rif_redet_as" placeholder="<?php esc_html_e('Enter your number of card or RIF', 'houzez'); ?>" type="number">
					</div>
				</div>
				<div class="col-md-12 col-sm-12">
					<div class="form-group">
		...
		<button id="add_new_lead_redet_as" type="button" class="btn btn-primary btn-full-width mt-2">
